...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    pillar2Subtitle: 'Soldes Wise, Paysera, RedotPay & USDT',
    ...
    resVirtualTitle: 'Wise / Paysera / RedotPay',
    ...
    footerRights: 'DZ EXCHANGE Tracker • Algérie • Taux de Change Temps Réel',
  ...
  ar: {
    ...
    pillar2Subtitle: 'رصيد وايز، بايسيرا، ريدوتباي و USDT',
    ...
    resBankBadge: 'رسمي',
    resVirtualTitle: 'وايز / بايسيرا / ريدوتباي',
    ...
    footerRights: 'ديزاد إكسشينج DZ EXCHANGE Tracker • الجزائر • أسعار الصرف لحظة بلحظة',
